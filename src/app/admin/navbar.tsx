...
const data = [
  { link: '/admin', label: 'Home', icon: IconHome },
  { link: '/admin/events', label: 'Events', icon: IconCalendarEvent },
  { link: '/admin/tickets', label: 'Tickets', icon: IconTicket },
  { link: '/admin/events/usermanagement', label: 'Users', icon: IconUser },
  { link: '/admin/events/attendee', label: 'Attendees', icon: IconChecklist },
];
