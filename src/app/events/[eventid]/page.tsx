...
const Page = () => {
    ...
    useEffect(() => {
        axios
            .get('/api/events/' + eventid + "/ticket?user=" + "666933bf8757909f1d0dbb47")
            .then((response) => {
                ...
                (event?.eventType ? (
                    ...
                    <div className="p-4">
                        <div className="flex items-center justify-between">
                            ...
                            <span
                                className="bg-pink-200 text-pink-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">QR Code</span>
                        </div>
